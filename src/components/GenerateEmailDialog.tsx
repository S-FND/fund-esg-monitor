  ...
  const handleDownload = async (companyId: string) => {
    ...
    if (format === 'docx') {
      // const blob = await generateEmailDOCX(company, ranking, companyRaw, rawData, rankings, overallProgress, scoreFormat);
       const blob = await generateEmailDOCXV1(company, ranking, companyRaw, rawData, rankings, overallProgress, scoreFormat);
      ...
      const html = generateEmailHTMLV1(company, ranking, companyRaw, rawData, rankings, overallProgress, scoreFormat);
